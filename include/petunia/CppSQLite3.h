...
public:
  ...
  size_t getSizeTField(int nField, long long nNullValue = 0) const;
  size_t getSizeTField(const char *szField, long long nNullValue = 0) const;
...
public:
  ...
  void bindInt64(int nParam, const long long nValue);
  ...
  void bindInt64(const char *szParam, const long long nValue);
  void bindSizeT(const char *szParam, size_t nValue);
